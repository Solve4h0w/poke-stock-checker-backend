...
const VISITOR_ID =
  process.env.TARGET_VISITOR_ID || "01989633EB690201997B4F22E8604F90";

// API key (from DevTools “key=” param)
const WEB_KEY =
  process.env.TARGET_WEB_KEY ||
  "9f36aeafbe60771e321a7cc95a78140772ab3e96";

// Your desktop Chrome User-Agent
const USER_AGENT =
  process.env.TARGET_UA ||
...
export async function fetchItemStatus(tcin) {
  ...
  // If Target didn't give us 200, surface why
  ...
  // Try to locate the first variant/child in the PDP response
  ...
  // THIS is what we return to the API caller
  return {
    ok: true,
    tcin,
    title,
    ...
    // we still include raw if you want to debug deeper in dev
    raw: data,
  };
}
